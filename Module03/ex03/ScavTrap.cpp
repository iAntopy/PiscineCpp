...
/*   Updated: 2023/02/23 00:40:23 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int		ScavTrap::getHP(void) const {return (_hp);}
unsigned int		ScavTrap::getEP(void) const {return (_ep);}
unsigned int		ScavTrap::getDMG(void) const {return (_dmg);}
